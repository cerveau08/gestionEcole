...
class SpecialtyController extends Controller
{
    ...
    public function adOnSchool(Request $request, $id)
    {
        $specialty = Speciality::findOrFail($id);
        $ecoleId = Ecole::findOrFail($request->ecole_id);
        $specialty->save();
        ...
        return response()->json([
            "success" => true,
            "message" => "specialite ajouter dans .$ecoleId avec succe",
            "date" => $specialty
        ], Response::HTTP_OK);
    }
    ...
    {
        $specialty = spec$specialty::findOrFail($id);
        $specialty->delete();

        return response()->json([
            'success' => true,
            "message" => "spec$specialty supprimer avec succee",
            'data' => $specialty
        ], Response::HTTP_OK);
    }
}
